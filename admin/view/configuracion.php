                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-sm" id="tableCategorias" style="width: 100%">
                                                <thead>
                                                    <tr>
                                                        <th>Categoria</th>
                                                    </tr>
                                    ...
                                    <div class="card-footer">
                                        <div class="d-grid">
                                            <button class="btn btn-outline-primary p-0 m-0" id="btn_insertar_categoria">Insertar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
